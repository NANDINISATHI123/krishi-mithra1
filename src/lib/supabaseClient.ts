...
// FIX: Replaced environment variable access with hardcoded keys to resolve TypeScript errors
// without requiring changes to the TS/Vite configuration. This matches the pattern in the
// older `lib/supabaseClient.ts` file.
